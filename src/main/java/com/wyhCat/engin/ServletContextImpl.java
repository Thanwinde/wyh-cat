 ...
 * @author nsh
 * @data 2025/4/7 19:14
 * @description 负责管理servlet的上下文，也就是所有的servlet的地方
 * 每个servlet 对应 一个 ServletRegistrationImpl类，其中存储了servlet所需要的各种信息
 **/
public class ServletContextImpl implements ServletContext {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(servlet == null){
            ...
            writer.println("<h1>404 Not Found</h1><p>No mapping for URL: " + path + "</p>");
            writer.close();
            return;
        }
